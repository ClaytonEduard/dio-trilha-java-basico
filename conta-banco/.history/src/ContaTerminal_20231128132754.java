...
public class ContaTerminal {
    public static void main(String[] args) {
        ...
        mensagem = "Óla ";
        mensagem.concat(nomeCliente).concat(", obrigado por criar uma conta em nosso banco, sua agência é ").concat(agencia).concat(", conta ").concat(numero).concat( e seu saldo R$ );
    }
}
